 ...
 */
 ...
 /*
  *
  *  Modified 2021-08-10 by Mike Pluta
  *
  */
...
metadata {
	definition (	name: "My Hue Motion Sensor",
					namespace: "hue",
					...
					ocfDeviceType: "x.com.st.d.sensor.motion"	) {
																		...
																		fingerprint		profileId: "0104", 
																						inClusters: "0000,0001,0003,0400,0402,0406", 
																						outClusters: "0019", 
																						manufacturer: "Philips", 
																						model: "SML001", 
																						deviceJoinName: "Hue Motion Sensor"
	}
    
    preferences {        
        section {
			input "motionSensitivity", "enum", title: "My Motion Sensitivity", options: ["Low", "Medium", "High"], displayDuringSetup: false, defaultValue: "High"
		}
