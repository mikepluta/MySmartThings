/**
 *  Hue Dimmer Switch Device Handler
 *
 *  Copyright 2016 Stephen McLaughlin
 *  Copyright 2018 Mike Pluta
 *
 ...
 */
metadata {
	definition (name: "Hue Dimmer Switch", namespace: "mikepluta", author: "Mike Pluta") {
